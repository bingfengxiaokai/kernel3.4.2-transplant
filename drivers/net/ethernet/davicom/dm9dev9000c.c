...
{
	//struct dmfe_board_info *db = (board_info_t *)netdev_priv(dev);
...
int __init dm9000c_init(void)
{
	...
	*bwscon = val;
	 ...
	 *
	 */
	//*bankcon4 = (7<<8)|(1<<6);	/* 对于DM9000C可以设Tacc为1, 对于DM9000E,Tacc要设大一点,比如最大值7  */
